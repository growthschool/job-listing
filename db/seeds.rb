...
puts "seed file for week2 - upload - resume。一個admin帳號, 並且創建 10 個 public jobs, 以及10個hidden jobs"
...
create_account = User.create([email: '222222@gmail.com', password: '111111', password_confirmation: '111111', is_admin: 'false'])
create_account = User.create([email: '333333@gmail.com', password: '111111', password_confirmation: '111111', is_admin: 'false'])
create_account = User.create([email: '444444@gmail.com', password: '111111', password_confirmation: '111111', is_admin: 'false'])
